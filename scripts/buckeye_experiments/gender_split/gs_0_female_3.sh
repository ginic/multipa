...
#SBATCH --nodes=1
#SBATCH --time 3:00:00
#SBATCH -o %j_gender_split_0_female_3.out
#SBATCH --exclude gpu010,gpu040,gpu038
#SBATCH --mail-type END

batch_size=4
grad_acc=4
learning_rate=3e-4
model_dir=data/models/gender_split_0_female_3
...
multipa-train --output_dir "$model_dir" --data_dir "$data_dir" --cache_dir "$dataset_cache" --use_gpu --num_gpus 4 --num_train_epochs 10 --num_proc 8 \
    ...
    --train_seed 809 \
    buckeye --train_samples 4000 --val_samples 5605 --percent_female 0.0 