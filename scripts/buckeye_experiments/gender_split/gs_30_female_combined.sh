...
for i in "${!seeds[@]}"; do
    seed=${seeds[$i]}
    model_dir=data/models/gender_split_30_female_$i

    echo "Starting training for gender_split_30_female_$i with seed=$seed"
    ...
    echo "Finished training for gender_split_30_female_$i"
done
