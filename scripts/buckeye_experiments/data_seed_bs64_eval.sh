...
multipa-evaluate --local_models \
 data/models/data_seed_bs64_1/wav2vec2-large-xlsr-buckeye-ipa \
 data/models/data_seed_bs64_2/wav2vec2-large-xlsr-buckeye-ipa \
 data/models/data_seed_bs64_3/wav2vec2-large-xlsr-buckeye-ipa \
 data/models/data_seed_bs64_4/wav2vec2-large-xlsr-buckeye-ipa \
