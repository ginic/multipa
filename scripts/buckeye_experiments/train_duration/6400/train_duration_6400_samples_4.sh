...
#SBATCH --nodes=1
#SBATCH --time 3:00:00
#SBATCH -o %j_train_duration_6400_samples_4.out
#SBATCH --mail-type END

batch_size=4
grad_acc=4
learning_rate=3e-4
model_dir=data/models/train_duration_6400_samples_4
rand_seed=505
train_samples=6400
...
multipa-train --output_dir "$model_dir" --data_dir "$data_dir" --cache_dir "$dataset_cache" --use_gpu --num_train_epochs 10 --num_proc 6 \
