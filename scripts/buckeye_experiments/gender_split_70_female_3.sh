...
grad_acc=4
learning_rate=3e-4
model_dir=data/models/gender_split_70_female_3
...
multipa-train --output_dir "$model_dir" --data_dir "$data_dir" --no_space --cache_dir "$dataset_cache" --use_gpu --num_gpus 8 --num_train_epochs 10 --num_proc 12 \
