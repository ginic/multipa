...
multipa-evaluate --local_models \
 data/models/data_seed_1/wav2vec2-large-xlsr-53-buckeye-ipa \
 data/models/data_seed_2/wav2vec2-large-xlsr-53-buckeye-ipa \
 data/models/data_seed_3/wav2vec2-large-xlsr-53-buckeye-ipa \
 data/models/data_seed_4/wav2vec2-large-xlsr-53-buckeye-ipa \
